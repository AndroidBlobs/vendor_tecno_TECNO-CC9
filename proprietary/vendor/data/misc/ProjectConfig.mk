...
AUTO_ADD_GLOBAL_DEFINE_BY_VALUE = CUSTOM_SKIN_COLOR_COMPATIBLE CUSTOM_TRAN_PROJECT CUSTOM_TRAN_BOM CUSTOM_TRAN_PCBA CUSTOM_HAL_LENS BOOT_LOGO MTK_AUDIO_BLOUD_CUSTOMPARAMETER_REV MTK_PLATFORM CUSTOM_KERNEL_LENS CUSTOM_KERNEL_MAIN_BACKUP_LENS MTK_MODEM_SUPPORT CUSTOM_KERNEL_MAIN_IMGSENSOR MTK_BT_CHIP MTK_WLAN_CHIP CUSTOM_KERNEL_SUB_BACKUP_IMGSENSOR CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR CUSTOM_KERNEL_FLASHLIGHT CUSTOM_KERNEL_SUB_IMGSENSOR CUSTOM_KERNEL_SUB_LENS CUSTOM_KERNEL_IMGSENSOR MTK_FM_RX_AUDIO MTK_COMBO_CHIP MTK_GPS_CHIP CUSTOM_KERNEL_SUB_BACKUP_LENS CUSTOM_KERNEL_MAIN_LENS MTK_FM_CHIP CUSTOM_KERNEL_MAIN2_IMGSENSOR BOOT_LOGO
#BSP:modify CCJHLEL-7 by zhijun.ye 20190520 start
BOOT_LOGO = hdplus1548
#BSP:modify CCJHLEL-7 by zhijun.ye 20190520 end
BUILD_AGO_GMS = no
BUILD_KERNEL = yes
BUILD_LK = yes
BUILD_MD32 = no
...
BUILD_PRELOADER = yes
BUILD_UBOOT = no
#BSP: add custom macro by wanghanfeng 20190509 start
CUSTOM_BUILD_VERNO = CY-CC9-H626-F
#BSP: add custom macro by wanghanfeng 20190509 end
...
#ITD:modify CCJHLEL-3 by wei.wang2 20190516 start
CUSTOM_HAL_CAMERA = camera
CUSTOM_HAL_CAM_CAL =
#ITD:modify CCJHLEL-3 by wei.wang2 20190516 end
CUSTOM_HAL_COMBO = mt6765
#ITD:modify CCJHLEL-3 by wei.wang2 20190516 start
CUSTOM_TRAN_PCBA = tran_pcba_h626
CUSTOM_HAL_EEPROM = dummy_eeprom
CUSTOM_HAL_FLASHLIGHT = dummy_flashlight
#ITD:modify CCJHLEL-208 by wei.wang2 20190614 start
CUSTOM_SKIN_COLOR_COMPATIBLE = yes
CUSTOM_HAL_IMGSENSOR = s5k3p9sx_mipi_raw s5k3p9sxb_mipi_raw s5kgd1_mipi_raw s5kgd1b_mipi_raw sp250a_mipi_raw sp250ab_mipi_raw ov2685_mipi_raw ov2685b_mipi_raw gc8034main_mipi_raw gc8034mainb_mipi_raw
#ITD:modify CCJHLEL-208 by wei.wang2 20190614 end
CUSTOM_TRAN_CAM_MATERIAL_CODE = s5k3p9sx_17201565 s5kgd1_17201558 sp250a_17201564 ov2685_17201627 gc8034_17201548
#ITD:modify CCJHLEL-208 by wei.wang2 20190614 start
...
#ITD:modify CCJHLEL-208 by wei.wang2 20190614 start
CUSTOM_HAL_MAIN2_IMGSENSOR = sp250a_mipi_raw sp250ab_mipi_raw ov2685_mipi_raw ov2685b_mipi_raw
#ITD:modify CCJHLEL-208 by wei.wang2 20190614 end
...
#ITD:modify CCJHLEL-3 by wei.wang2 20190516 end
#BSP: add CCQHLEL-18 by changliang.guo 20190516 start
...
#BSP: add KCEGHLYQ-44 by changliang.guo 20190521 start
CUSTOM_KERNEL_BAROMETER = no
#BSP: add KCEGHLYQ-44 by changliang.guo 20190521 end
...
#ITD:modify CCJHLEL-3 by wei.wang2 20190516 start
CUSTOM_KERNEL_IMGSENSOR = s5k3p9sx_mipi_raw s5kgd1_mipi_raw sp250a_mipi_raw ov2685_mipi_raw gc8034main_mipi_raw
...
CUSTOM_KERNEL_MAIN2_IMGSENSOR = sp250a_mipi_raw ov2685_mipi_raw
...
#BSP:add ASQHLYB-0 by fan.peng 20190520 start
TRAN_FINGERPRINT_SUPPORT = goodix_tee
TRAN_OPTICAL_FINGERPRINT=yes
#BSP:add ASQHLYB-0 by fan.peng 20190520 end
...
#TSD: modify XLEWHLES-3116 by chaochao.he 20190513 start
CUSTOM_MODEM=cc9_h626_f1
#TSD: modify XLEWHLES-3116 by chaochao.he 20190513 end
...
LCM_FAKE_HEIGHT = 0
LCM_FAKE_WIDTH = 0
#BSP:modify LBBHLYYL-1 by chenglong.jiang 20190513 start
LCM_HEIGHT = 1548
LCM_WIDTH = 720
#BSP:modify LBBHLYYL-1 by chenglong.jiang 20190513 end
...
MTK_ANT_SUPPORT = no
#APP: modify wangweidong for AOD start
MTK_AOD_SUPPORT = yes
#APP: modify wangweidong for AOD end
MTK_API_CHECK = yes
...
#BSP:modify CCJHLEL-1 by shuanglei.wang 20190515 start
MTK_AUDIO_NUMBER_OF_MIC = 1
#BSP:modify CCJHLEL-1 by shuanglei.wang 20190515 end
...
#[ITD] modify for Close HDR by wei.wang2 20190531 start
MTK_CAM_HDR_SUPPORT = no
#[ITD] modify for Close HDR by wei.wang2 20190531 end
...
#[ITD] add for thirdpart apk by wei.wang2 20190531 start
...
TRAN_CAMERA_ARCSOFTALGO_DUALCAM = yes
#[ITD] add for thirdpart apk by wei.wang2 20190531 end
MTK_CAM_STEREO_DENOISE_SUPPORT = no
MTK_CAM_SW_VERSION = ver1
MTK_CAM_USER_DBG_LOG_OFF = no
#[ITD] modify for Close VHDR by wei.wang2 20190531 start
MTK_CAM_VHDR_SUPPORT = no
#[ITD] modify for Close VHDR by wei.wang2 20190531 end
MTK_CAM_VIDEO_FACEBEAUTY_SUPPORT = no
MTK_CAM_VSDOF_SUPPORT = no
MTK_CAM_VSS_SUPPORT = yes
#[ITD] modify for Close ZSDHDR by wei.wang2 20190531 start
MTK_CAM_ZSDHDR_SUPPORT = no
#[ITD] modify for Close ZSDHDR by wei.wang2 20190531 end
...
#SID1: add CCQHLEL-22 by yehui.xu 2019.03.28 start
MTK_CTA_SET = no
#SID1: add CCQHLEL-22 by yehui.xu 2019.03.28 end
MTK_CTA_SUPPORT = no
MTK_CTM_SUPPORT = no
...
#BSP:modify CCQHLEL-17 by fan.hong 20190513 start
MTK_DUAL_CHARGER_SUPPORT = no
#BSP:modify CCQHLEL-17 by fan.hong 20190513 end
...
#BSP: modify XLELHLES-7 by shentao.yang for f2fs not support FBE now 20190604 start
MTK_ENCRYPTION_FDE_TO_FBE = no
MTK_ENCRYPTION_TYPE_FILE = no
#BSP: modify XLELHLES-7 by shentao.yang for f2fs not support FBE now 20190604 end
...
MTK_FIRST_MD = 1
#TSD: modify CCQHLEL-1617 by kang.wang 20190708 start
MTK_FLIGHT_MODE_POWER_OFF_MD = no
#TSD: modify CCQHLEL-1617 by kang.wang 20190708 end
...
#BSP: modify for XLELHLES-7 by shentao.yang 20190516 start
#BSP: modify for XLELHLES-7 by shentao.yang 20190516 end
...
MTK_TOUCH_BOOST = no
MTK_TTY_SUPPORT = yes
# BSP:Add CCJHLEL-50 by cheng.chen3 20190611 start
MTK_UART_USB_SWITCH = yes
# BSP:Add CCJHLEL-50 by cheng.chen3 20190611 end
MTK_UCE_SUPPORT = no
MTK_UFS_OTP = no
...
#PPD: add CCQHLEL-723 by zihan.guo 19/07/22 start version 1.0.0.1
MTK_ARC_GIFT_SUPPORT = yes
#PPD: add CCQHLEL-723 by zihan.guo 19/07/22 end
#BSP: add custom macro by wanghanfeng 20190507 start
#SID:add CCJHLEL-27 lijia.chen 2019.05.29 start
MTK_BUILD_VERNO=CC9-H626FGH-P-200106V274
FINGERPRINT_BUILD_VERNO=FGH-200106V274
#SID:add CCJHLEL-27 lijia.chen 2019.05.29 end
TRAN_SYSTEM_DEVINFO = yes
CUSTOM_TRAN_PROJECT=tran_cc9
CUSTOM_TRAN_BOM=tran_cc9_f1
...
#BSP: add custom macro by wanghanfeng 20190507 end
#BSP:add CCJHLEL-1 by shuanglei.wang 20190515 start
TRAN_AUDIOTEST_SUPPORT = yes
TRAN_NEW_LOOPBACK_TEST = yes
#BSP:add CCJHLEL-1 by shuanglei.wang 20190515 end

#BSP: add CCJHLEL-5 by qiuwei.wang 20190520 start
TRAN_TP_SUPPORT = yes
#BSP: add CCJHLEL-5 by qiuwei.wang 20190520 end

#ITD:add cam 3pty function XWWYLHLYS-302 by xiaoxue.cai 20190531 start
TRAN_CAMERA_FEATURE = yes
#ITD:add cam 3pty function XWWYLHLYS-302 by xiaoxue.cai 20190531 end

##################FDD Start#######################
#PPD: add Sleep Master2.0 start by yangjian 20190514
TRAN_WAKELOCK_MANAGER_SUPPORT = no
TRAN_ALARM_MANAGER_SUPPORT = yes
#PPD: add Sleep Master2.0 start by yangjian 20190514
###################FDD End#######################
#BSP: add  CCJHLEL-1841 by tao.lan 20191024 start
TRAN_PS_CALI_FAC = no
#BSP: add  CCJHLEL-1841 by tao.lan 20191024 end
